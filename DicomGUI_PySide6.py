...
class Ui_Form(QWidget):
    ...
    def crearVideo(self):
        ...
        for filename in sorted(glob.glob(ruta)): #recorre todos los archivos .png de la carpeta /*png
            ...
            height, width, _ = img.shape #obtiene el tamaño de la imagen (ancho, alto y numero de colores)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", u"Conversión de imágenes"))
        self.label_3.setText(_translate("Form", u"Video con imágenes"))
        ...
        self.label_7.setText(_translate("Form", u"Ruta  imágenes:"))
